    ...
    <div className="mx-auto max-w-[1400px] px-6 py-8">
      <div className="mb-6 flex items-center justify-between print:hidden">
        ...
        <div className="flex gap-2">
          ...
          <button onClick={() => { setCentralNotas([]); setUploadedNotas([]); }} className="flex items-center gap-2 rounded-lg border border-[#334155] bg-[#1e293b] px-4 py-2 text-sm text-[#f1f5f9] hover:bg-[#334155]">Nova consulta</button>
        </div>
      </div>
